...
public class PagingBeanEX {
  ...
  * 2페지이의 시작번호는 1페이지의 마지막 번호(5) + 1 이 시작번호이다.
  * 
  * @return
  */
 ...
 public int getEndRowNumber() {  
	 ...
	 return endRowNumber;
	 //return nowPage*postCountPerPage>totalPostCount?totalPostCount:nowPage*postCountPerPage; -- 삼항 조건
 }
 ...
 public int getEndPageOfPageGroup() {
	 int num = pageCountPerPageGroup*getNowPageGroup();
	 if(num>getTotalPage()) {
		 num=getTotalPage();
	 }
	 return num;
 ...
 public static void main(String args[]) {
  ...
  System.out.println("////////////////////////////");
  p = new PagingBeanEX(31, 6);// 게시물수 31 현재 페이지 6
